...
window.onload = function () {
  ...
  $runType.addEventListener("change", function (event) {
    ...
    if (val === 'forward') {
      setAttr([$targetAddr.parentElement, $targetPort.parentElement, $udpTimeout.parentElement], "class", "");
    } else {
      setAttr([$targetAddr.parentElement, $targetPort.parentElement, $udpTimeout.parentElement], "class", "hidden");
    }

    if (val === 'server') {
      setAttr([$key.parentElement, $keyPassword.parentElement, $preferServerCipher.parentElement, $sessionTimeout.parentElement, $plainHttpResponse.parentElement, $dhparam.parentElement, $preferIpv4.parentElement, $mysql], "class", "");
      setAttr([$verify.parentElement, $verifyHostname.parentElement], "class", "hidden");
    } else {
      setAttr([$key.parentElement, $keyPassword.parentElement, $preferServerCipher.parentElement, $sessionTimeout.parentElement, $plainHttpResponse.parentElement, $dhparam.parentElement, $preferIpv4.parentElement, $mysql], "class", "hidden");
